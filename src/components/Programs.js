                    ...
                    <div className="course-container">
                      <div className="accordion active">
                        <div className="accordion-header">
                          About Bachelor of Public Health (BPH)
                        </div>
                        <div className="accordion-content">
                          <p align="justify">
                            Bachelor of Public Health (BPH) is an undergraduate
                            degree programme designed to address the growing
                            demand for professionals who can understand, analyse
                            and respond to complex public health challenges.
                            This interdisciplinary program integrates principles
                            from medicine, social sciences, policy and
                            management to develop well-rounded graduates capable
                            of making a positive impact on public health
                            systems. A crucial component of the program is
                            practical training and internships, where students
                            gain real-world experience by working with public
                            health agencies, NGOs, healthcare facilities and
                            research institutions. Choice based electives is
                            another highlight of the programme, allowing
                            students to tailor their education based on their
                            interests and career aspirations, making the program
                            versatile and adaptable to changing needs. Students
                            can opt for electives in the areas of epidemiology,
                            health promotion, healthcare management,
                            environmental health and more. Bachelor of Public
                            Health is a three year degree program. Its having
                            extended specialization & internship period,
                            building professional skills both on academic as
                        ...
                        <div className="accordion-content">
                          <ul>
                            <li>
                              ...
                              successfully completed the 10+2 or an equivalent
                              examination in any stream from a recognized board
